...
<!-- Content Row -->
        <div class="card shadow">
            ...
            <h1 class="h3 mb-0 text-gray-800">{{ __('create building') }}</h1>
                <div class="ml-auto">
            ...
            <div class="card-body">
                <form action="{{ route('admin.rooms.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="room_number">{{ __('Building name') }}</label>
                        <input type="text" class="form-control" id="room_number" placeholder="{{ __('Building name') }}" name="room_number" value="{{ old('room_number') }}" />
                    </div>
                    <div class="form-group">
